...
$(document).ready(function () {
    ...
    $('#DROOfficeListID').change(function () {
        ...
        $.ajax({
            url: '/KaveriIntegration/KaveriIntegration/GetSROOfficeListByDistrictID',
            data: { "DistrictID": $('#DROOfficeListID').val() },
            datatype: "json",
            type: "GET",
            success: function (data) {
    ...
    $("#SearchBtn").click(function () {
        ...
        //$.ajax({
        //    url: '/KaveriIntegration/KaveriIntegration/LoadKaveriIntegrationTable/',
        //    data: { 'FromDate': txtFromDate, 'ToDate': txtToDate, 'DistrictID': DistrictID },
        //    datatype: "json",
        //    headers: header,
        //    type: "POST",
        //    success: function (data) {
        ...
        var DROfficeWiseSummaryTableID = $('#DROfficeWiseSummaryTableID').DataTable({
            ...
            columns: [
                ...
                { data: "EAasthi", "searchable": true, "visible": true, "name": "Mojani" },
    ...
    //$('#DtlsSearchParaListCollapse1').click(function () {
    //    var classToRemove = $('#DtlsToggleIconSearchPara1').attr('class');
    //    var classToSet = (classToRemove == "fa fa-plus-square-o fa-pull-left fa-2x" ? "fa fa-minus-square-o fa-pull-left fa-2x" : "fa fa-plus-square-o fa-pull-left fa-2x");
    //    $('#DtlsToggleIconSearchPara1').removeClass(classToRemove).addClass(classToSet);
    //});

    //$('#MasterTableModel').modal({
    //    backdrop: 'static',
    //    keyboard: false
    //});
...
function GetOtherTableDetails(columnName, SROCode) {
    ...
    var AnywhereECTable = $('#AnywhereECTable').DataTable({
        ajax: {
            url: '/KaveriIntegration/KaveriIntegration/OtherTableDetails',
            type: "POST",
            headers: header,
            data: {
...
function EXCELDownloadFun(FromDate, ToDate, DistrictID, SroID) {
    window.location.href = '/KaveriIntegration/KaveriIntegration/ExportToExcel?FromDate=' + FromDate + '&ToDate=' + ToDate + '&DistrictID=' + DistrictID + '&SroID=' + SroID;
}

function ExportToExcelDetails(FromDate, ToDate, SROCode, columnName) {
    window.location.href = '/KaveriIntegration/KaveriIntegration/ExportToExcelDetails?FromDate=' + FromDate +
