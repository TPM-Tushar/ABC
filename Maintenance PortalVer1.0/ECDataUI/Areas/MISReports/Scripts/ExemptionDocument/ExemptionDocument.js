...
$(document).ready(function () {
    ...
    $("#SearchBtn").click(function () {
        ...
        //$.ajax({
        //    url: '/MISReports/ExemptionDocument/ExemptionDocumentSummary/',
        //    data: {
        ...
        var tableIndexReports = $('#jurisdictionalDetailsID').DataTable({
            ...
            ajax: {
                url: '/MISReports/ExemptionDocument/ExemptionDocumentDetail',
                type: "POST",
                headers: header,
                data: {
                    'fromDate': FromDate, 'ToDate': ToDate, 'SROOfficeListID': SROOfficeListID//, 'DROfficeID': DROfficeID
            ...
            columns: [
                ...
                { data: "STAMPDUTY_BEFORE_EXEMPTION", "searchable": true, "visible": true, "name": "STAMPDUTY_BEFORE_EXEMPTION" },
                { data: "EXEMPTION_GIVEN", "searchable": true, "visible": true, "name": "EXEMPTION_GIVEN" },
                { data: "STAMPDUTY_AFTER_EXEMPTION", "searchable": true, "visible": true, "name": "STAMPDUTY_AFTER_EXEMPTION" },
...
function PDFDownloadFun(FromDate, ToDate, SROOfficeListID) {
    window.location.href = '/MISReports/ExemptionDocument/ExemptionDocumentToPDF?FromDate=' + FromDate + "&ToDate=" + ToDate + "&SROOfficeListID=" + SROOfficeListID + "&MaxDate=" + MaxDate;
}

function EXCELDownloadFun(FromDate, ToDate, SROOfficeListID) {
    window.location.href = '/MISReports/ExemptionDocument/ExportExemptionDocumentToExcel?FromDate=' + FromDate + "&ToDate=" + ToDate + "&SROOfficeListID=" + SROOfficeListID + "&MaxDate=" + MaxDate;
}