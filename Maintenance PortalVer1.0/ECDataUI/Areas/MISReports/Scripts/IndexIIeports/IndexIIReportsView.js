...
$(document).ready(function () {
    ...
    $('#DROOfficeListID').change(function () {
        ...
        $.ajax({
            url: '/MISReports/IndexIIReports/GetSROOfficeListByDistrictID',
    ...
    $("#SearchBtn").click(function () {
        ...
        if (DROfficeID == "0") {
            ...
            var tableIndexReports = $('#IndexIIReportsID').DataTable({
                ...
                ajax: {
                    url: '/MISReports/IndexIIReports/GetIndexIIReportsDetails',
                    type: "POST",
                    headers: header,
                    data: {
                ...
                columnDefs: [
                    ...
                    { "className": "dt-center", "targets": [0, 1, 2, 3, 4, 6, 7, 8, 9, 10, 11] },
...
function PDFDownloadFun(FromDate, ToDate, SROOfficeListID, NatureOfDocumentListID, Amount) {
    ...
    window.location.href = '/MISReports/IndexIIReports/ExportIndexIIReportToPDF?FromDate=' + FromDate + "&ToDate=" + ToDate + "&SROOfficeListID=" + SROOfficeListID + "&NatureOfDocumentListID=" + NatureOfDocumentListID + "&Amount=" + Amount + "&DROOfficeListID=" + DROfficeID;
}


function EXCELDownloadFun(FromDate, ToDate, SROOfficeListID, NatureOfDocumentListID, Amount) {

    window.location.href = '/MISReports/IndexIIReports/ExportIndexIIReportToExcel?FromDate=' + FromDate + "&ToDate=" + ToDate + "&SROOfficeListID=" + SROOfficeListID + "&NatureOfDocumentListID=" + NatureOfDocumentListID + "&Amount=" + Amount + "&DROOfficeListID=" + DROfficeID;

}

//function ValidateParameter(FinalRegNo) {
//    //alert('ValidateParameter');
//    $('#divViewAbortModal').modal('show');
//    $("#objPDFViewer").attr('data', '');
//    $("#objPDFViewer").attr('data', '/MISReports/IndexIIReports/DisplayScannedFile?FRN=' + FinalRegNo);
//    $("#objPDFViewer").load('/MISReports/IndexIIReports/DisplayScannedFile?FRN=' + FinalRegNo);
...
function ValidateParameter(FinalRegNo) {
    //alert(FinalRegNo);
    $.ajax({
        url: '/MISReports/IndexIIReports/ValidateParameters',
        data: { "FRN": FinalRegNo },
        datatype: "json",
        type: "GET",
        success: function (data) {
