...
$(document).ready(function () {
    ...
    $('#DROOfficeListID').change(function () {
        ...
        $.ajax({
            url: '/MISReports/SROChallanCollection/GetSROOfficeListByDistrictID',
    ...
    $("#excelDownload").click(function () {
        ...
        blockUI('Loading data please wait.');
        $.ajax({
            url: '/MISReports/SROChallanCollection/ValidateSearchParameters',
            data: { "fromDate": FromDate, "ToDate": ToDate, "SROOfficeListID": SROOfficeListID, "DROfficeID": DROOfficeListID },
            type: "GET",
            success: function (data) {
                if (data.success == true) {
                    window.location.href = '/MISReports/SROChallanCollection/ExportToExcel?FromDate=' + FromDate + "&ToDate=" + ToDate + "&SROOfficeListID=" + SROOfficeListID + "&DROfficeID=" + DROOfficeListID + "&SelectedDistrict=" + SelectedDistrict + "&SelectedSRO=" + SelectedSRO;
                    //unBlockUI();
                }
                else {
                    unBlockUI();
