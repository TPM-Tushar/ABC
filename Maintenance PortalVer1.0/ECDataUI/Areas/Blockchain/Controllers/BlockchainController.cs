...
namespace ECDataUI.Areas.Blockchain.Controllers
{
    ...
    public class BlockchainController : Controller
    {
        ...
        [MenuHighlight]
        public ActionResult BlockchainView()
        {
            try
            {
                ...
                caller = new ServiceCaller("BlockchainAPIController");
                BlockchainViewModel reqModel = caller.GetCall<BlockchainViewModel>("BlockchainView", new { officeID = OfficeID, LevelID = LevelID, UserID = UserID });
        ...
        [EventAuditLogFilter(Description = "Populate Data Table with unapproved list with respect to selected SRO and District")]
            ...
            try
            {
                ...
                else
                {
                    ...
                    var gridData = reqModel.Select(BlockchainApprovalTableModel => new
                    {
                        ...
                        Action = BlockchainApprovalTableModel.Action,
                        DocumentID = BlockchainApprovalTableModel.DocumentID,
                        SROCode = BlockchainApprovalTableModel.SROCode
        ...
        [HttpPost]
        [ValidateAntiForgeryTokenOnAllPosts]
        [EventAuditLogFilter(Description = "Approves all the selected rows and sets IsApproved as true in db")]
        public string Approval(List<string> appList)
        {
            string errorMessage = string.Empty;
            caller = new ServiceCaller("BlockchainAPIController");
            string resultModel = caller.PostCall<List<string>, string>("Approval", appList , out errorMessage);
            return resultModel;
        }
