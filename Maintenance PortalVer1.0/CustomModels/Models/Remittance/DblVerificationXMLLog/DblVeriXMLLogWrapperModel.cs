...
namespace CustomModels.Models.Remittance.DblVerificationXMLLog
{
   public  class DblVeriXMLLogWrapperModel
    {
        public List<DblVeriXMLLogDetail> DblVeriXMLLogDetailList { get; set; }
    ...
    public class DblVeriXMLLogDetail
    {
    ...
    public class DblVeriReqXMLLogModel
    {       
