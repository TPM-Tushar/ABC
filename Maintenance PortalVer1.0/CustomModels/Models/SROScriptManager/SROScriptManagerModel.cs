...
{
    public class SROScriptManagerModel
    {
    ...
    public class ScriptManagerDetailWrapperModel
    {
        public List<ScriptManagerDetailModel> ScriptManagerDetailList { get; set; }
    ...
    public class ScriptManagerDetailModel
    {
