...
namespace CustomModels.Models.KaveriIntegration
{
    public class KaveriIntegrationModel
    {
    ...
    public class KaveriIntegrationWrapperModel
    {
        public List<KaveriIntegrationDetail> KaveriIntegrationDetailList { get; set; }

        public int TotalCount { get; set; }
    }

    public class KaveriIntegrationDetail
    {
        ...
        public String EAasthi { get; set; }

    }

    public class KIDetailsModel
    {
        public int SerialNo { get; set; }
    ...
    public class KIDetailsWrapperModel
    {
        public List<KIDetailsModel> KIDetailsModelList { get; set; }
